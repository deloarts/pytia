from pytia.framework.hybrid_shape_interfaces.hybrid_shape_3d_curve_offset import (
    HybridShape3DCurveOffset,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_affinity import (
    HybridShapeAffinity,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_assemble import (
    HybridShapeAssemble,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_axis_line import (
    HybridShapeAxisLine,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_axis_to_axis import (
    HybridShapeAxisToAxis,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_blend import (
    HybridShapeBlend,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_boundary import (
    HybridShapeBoundary,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_bump import HybridShapeBump
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_circle2_points_rad import (
    HybridShapeCircle2PointsRad,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_circle3_points import (
    HybridShapeCircle3Points,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_circle_bitangent_point import (
    HybridShapeCircleBitangentPoint,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_circle_bitangent_radius import (
    HybridShapeCircleBitangentRadius,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_circle_center_axis import (
    HybridShapeCircleCenterAxis,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_circle_center_tangent import (
    HybridShapeCircleCenterTangent,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_circle_ctr_pt import (
    HybridShapeCircleCtrPt,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_circle_ctr_rad import (
    HybridShapeCircleCtrRad,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_circle_explicit import (
    HybridShapeCircleExplicit,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_circle_tritangent import (
    HybridShapeCircleTritangent,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_combine import (
    HybridShapeCombine,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_conic import (
    HybridShapeConic,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_connect import (
    HybridShapeConnect,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_corner import (
    HybridShapeCorner,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_curve_explicit import (
    HybridShapeCurveExplicit,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_curve_par import (
    HybridShapeCurvePar,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_curve_smooth import (
    HybridShapeCurveSmooth,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_cylinder import (
    HybridShapeCylinder,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_develop import (
    HybridShapeDevelop,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_direction import (
    HybridShapeDirection,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_extract import (
    HybridShapeExtract,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_extract_multi import (
    HybridShapeExtractMulti,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_extrapol import (
    HybridShapeExtrapol,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_extremum import (
    HybridShapeExtremum,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_extremum_polar import (
    HybridShapeExtremumPolar,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_extrude import (
    HybridShapeExtrude,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_fill import HybridShapeFill
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_fillet_bi_tangent import (
    HybridShapeFilletBiTangent,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_fillet_tri_tangent import (
    HybridShapeFilletTriTangent,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_healing import (
    HybridShapeHealing,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_helix import (
    HybridShapeHelix,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_integrated_law import (
    HybridShapeIntegratedLaw,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_intersection import (
    HybridShapeIntersection,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_inverse import (
    HybridShapeInverse,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_law_dist_proj import (
    HybridShapeLawDistProj,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_line_angle import (
    HybridShapeLineAngle,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_line_bi_tangent import (
    HybridShapeLineBiTangent,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_line_bisecting import (
    HybridShapeLineBisecting,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_line_explicit import (
    HybridShapeLineExplicit,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_line_normal import (
    HybridShapeLineNormal,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_line_pt_dir import (
    HybridShapeLinePtDir,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_line_pt_pt import (
    HybridShapeLinePtPt,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_line_tangency import (
    HybridShapeLineTangency,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_loft import HybridShapeLoft
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_mid_surface import (
    HybridShapeMidSurface,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_near import HybridShapeNear
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_offset import (
    HybridShapeOffset,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_plane1_curve import (
    HybridShapePlane1Curve,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_plane1_line1_pt import (
    HybridShapePlane1Line1Pt,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_plane2_lines import (
    HybridShapePlane2Lines,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_plane3_points import (
    HybridShapePlane3Points,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_plane_angle import (
    HybridShapePlaneAngle,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_plane_equation import (
    HybridShapePlaneEquation,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_plane_explicit import (
    HybridShapePlaneExplicit,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_plane_mean import (
    HybridShapePlaneMean,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_plane_normal import (
    HybridShapePlaneNormal,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_plane_offset import (
    HybridShapePlaneOffset,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_plane_offset_pt import (
    HybridShapePlaneOffsetPt,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_plane_tangent import (
    HybridShapePlaneTangent,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_point_between import (
    HybridShapePointBetween,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_point_center import (
    HybridShapePointCenter,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_point_coord import (
    HybridShapePointCoord,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_point_explicit import (
    HybridShapePointExplicit,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_point_on_curve import (
    HybridShapePointOnCurve,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_point_on_plane import (
    HybridShapePointOnPlane,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_point_on_surface import (
    HybridShapePointOnSurface,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_point_tangent import (
    HybridShapePointTangent,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_polyline import (
    HybridShapePolyline,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_position_transfo import (
    HybridShapePositionTransfo,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_project import (
    HybridShapeProject,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_reflect_line import (
    HybridShapeReflectLine,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_revol import (
    HybridShapeRevol,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_rotate import (
    HybridShapeRotate,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_scaling import (
    HybridShapeScaling,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_section import (
    HybridShapeSection,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_sphere import (
    HybridShapeSphere,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_spine import (
    HybridShapeSpine,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_spiral import (
    HybridShapeSpiral,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_spline import (
    HybridShapeSpline,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_split import (
    HybridShapeSplit,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_surface_explicit import (
    HybridShapeSurfaceExplicit,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_sweep_circle import (
    HybridShapeSweepCircle,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_sweep_conic import (
    HybridShapeSweepConic,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_sweep_explicit import (
    HybridShapeSweepExplicit,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_sweep_line import (
    HybridShapeSweepLine,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_symmetry import (
    HybridShapeSymmetry,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_transfer import (
    HybridShapeTransfer,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_translate import (
    HybridShapeTranslate,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_trim import HybridShapeTrim
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_unfold import (
    HybridShapeUnfold,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_volume_explicit import (
    HybridShapeVolumeExplicit,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_wrap_curve import (
    HybridShapeWrapCurve,
)
from pytia.framework.hybrid_shape_interfaces.hybrid_shape_wrap_surface import (
...
class HybridShapeFactory(Factory):
    ...
    def add_new_3d_corner(
        ...
        return HybridShapeCorner(
            self.hybrid_shape_factory.AddNew3DCorner(
    ...
    def add_new_circle_center_axis_with_angles(
        ...
        return HybridShapeCircleCenterAxis(
            self.hybrid_shape_factory.AddNewCircleCenterAxisWithAngles(
                i_axis.com_object,
                i_point.com_object,
                i_value,
                i_projection,
    ...
    def add_new_circle_center_tangent(
        ...
        return HybridShapeCircleCenterTangent(
            self.hybrid_shape_factory.AddNewCircleCenterTangent(
    ...
    def add_new_circle_ctr_pt(
        ...
        return HybridShapeCircleCtrPt(
            self.hybrid_shape_factory.AddNewCircleCtrPt(
                i_center.com_object,
    ...
    def add_new_circle_ctr_pt_with_angles(
        ...
        return HybridShapeCircleCtrPt(
            self.hybrid_shape_factory.AddNewCircleCtrPtWithAngles(
                i_center.com_object,
                i_crossing_point.com_object,
                i_support.com_object,
                i_geodesic,
    ...
    def add_new_circle_ctr_rad_with_angles(
        ...
        return HybridShapeCircleCtrRad(
            self.hybrid_shape_factory.AddNewCircleCtrRadWithAngles(
                i_center.com_object,
                i_support.com_object,
                i_geodesic,
                i_radius,
    ...
    def add_new_circle_tritangent(
        ...
        return HybridShapeCircleTritangent(
            self.hybrid_shape_factory.AddNewCircleTritangent(
                i_curve1.com_object,
                i_curve2.com_object,
                i_curve3.com_object,
                i_support.com_object,
    ...
    def add_new_conical_reflect_line_with_type(
        ...
        return HybridShapeReflectLine(
            self.hybrid_shape_factory.AddNewConicalReflectLineWithType(
                i_support.com_object,
                i_origin.com_object,
                i_angle,
    ...
    def add_new_connect(
        ...
        return HybridShapeConnect(
            self.hybrid_shape_factory.AddNewConnect(
                i_curve1.com_object,
                i_point1.com_object,
                i_orient1,
                i_continuity1,
    ...
    def add_new_corner(
        ...
        return HybridShapeCorner(
            self.hybrid_shape_factory.AddNewCorner(
                i_element1.com_object,
                i_element2.com_object,
                i_support.com_object,
                i_radius,
    ...
    def add_new_curve_par(
        ...
        return HybridShapeCurvePar(
            self.hybrid_shape_factory.AddNewCurvePar(
                curve.com_object,
                support.com_object,
                distance,
                invert_direction,
    ...
    def add_new_extrude(
        ...
        return HybridShapeExtrude(
            self.hybrid_shape_factory.AddNewExtrude(
    ...
    def add_new_fillet_bi_tangent(
        ...
        return HybridShapeFilletBiTangent(
            self.hybrid_shape_factory.AddNewFilletBiTangent(
                i_element1.com_object,
                i_element2.com_object,
                i_radius,
                i_orientation1,
    ...
    def add_new_fillet_tri_tangent(
        ...
        return HybridShapeFilletTriTangent(
            self.hybrid_shape_factory.AddNewFilletTriTangent(
                i_element1.com_object,
                i_element2.com_object,
                i_remove_elem.com_object,
                i_orientation1,
                i_orientation2,
    ...
    def add_new_helix(
        ...
        return HybridShapeHelix(
            self.hybrid_shape_factory.AddNewHelix(
                i_axis.com_object,
                i_invert_axis,
                i_starting_point.com_object,
                i_pitch,
    ...
    def add_new_hybrid_trim(
        ...
        return HybridShapeTrim(
            self.hybrid_shape_factory.AddNewHybridTrim(
                i_element1.com_object,
                i_orientation1,
                i_element2.com_object,
                i_orientation2,
    ...
    def add_new_line_angle(
        ...
        return HybridShapeLineAngle(
            self.hybrid_shape_factory.AddNewLineAngle(
                i_curve.com_object,
    ...
    def add_new_line_bisecting(
        ...
        return HybridShapeLineBisecting(
            self.hybrid_shape_factory.AddNewLineBisecting(
                i_line1.com_object,
                i_line2.com_object,
                i_begin_offset,
                i_end_offset,
    ...
    def add_new_line_bisecting_on_support(
        ...
        return HybridShapeLineBisecting(
            self.hybrid_shape_factory.AddNewLineBisectingOnSupport(
                i_line1.com_object,
                i_line2.com_object,
                i_surface.com_object,
                i_begin_offset,
    ...
    def add_new_line_bisecting_on_support_with_point(
        ...
        return HybridShapeLineBisecting(
            self.hybrid_shape_factory.AddNewLineBisectingOnSupportWithPoint(
                i_line1.com_object,
                i_line2.com_object,
    ...
    def add_new_line_bisecting_with_point(
        ...
        return HybridShapeLineBisecting(
            self.hybrid_shape_factory.AddNewLineBisectingWithPoint(
                i_line1.com_object,
                i_line2.com_object,
                i_ref_point.com_object,
                i_begin_offset,
    ...
    def add_new_line_normal(
        ...
        return HybridShapeLineNormal(
            self.hybrid_shape_factory.AddNewLineNormal(
                i_surface.com_object,
                i_point.com_object,
                i_begin_offset,
                i_end_offset,
    ...
    def add_new_line_pt_dir(
        ...
        return HybridShapeLinePtDir(
            self.hybrid_shape_factory.AddNewLinePtDir(
                i_pt.com_object,
                i_direction.com_object,
                i_begin_offset,
                i_end_offset,
    ...
    def add_new_line_pt_dir_on_support(
        ...
        return HybridShapeLinePtDir(
            self.hybrid_shape_factory.AddNewLinePtDirOnSupport(
                i_pt.com_object,
                i_direction.com_object,
                i_support.com_object,
                i_begin_offset,
    ...
    def add_new_line_pt_pt_extended(
        ...
        return HybridShapeLinePtPt(
            self.hybrid_shape_factory.AddNewLinePtPtExtended(
    ...
    def add_new_line_pt_pt_on_support_extended(
        ...
        return HybridShapeLinePtPt(
            self.hybrid_shape_factory.AddNewLinePtPtOnSupportExtended(
                i_pt_origine.com_object,
                i_pt_extremite.com_object,
                i_support.com_object,
                i_begin_offset,
    ...
    def add_new_line_tangency(
        ...
        return HybridShapeLineTangency(
            self.hybrid_shape_factory.AddNewLineTangency(
                i_curve.com_object,
                i_point.com_object,
                i_begin_offset,
                i_end_offset,
    ...
    def add_new_line_tangency_on_support(
        ...
        return HybridShapeLineTangency(
            self.hybrid_shape_factory.AddNewLineTangencyOnSupport(
                i_curve.com_object,
                i_point.com_object,
                i_support.com_object,
                i_begin_offset,
    ...
    def add_new_mid_surface_with_auto_threshold(
        ...
        return HybridShapeMidSurface(
            self.hybrid_shape_factory.AddNewMidSurfaceWithAutoThreshold(
                i_support.com_object,
                i_creation_mode,
                i_threshold,
    ...
    def add_new_point_on_curve_with_reference_along_direction(
        ...
        return HybridShapePointOnCurve(
            self.hybrid_shape_factory.AddNewPointOnCurveWithReferenceAlongDirection(
                i_crv.com_object,
                i_pt.com_object,
                i_long,
                i_orientation,
    ...
    def add_new_reflect_line(
        ...
        return HybridShapeReflectLine(
            self.hybrid_shape_factory.AddNewReflectLine(
                i_support.com_object,
                i_dir.com_object,
                i_angle,
                i_orientation_support,
    ...
    def add_new_reflect_line_with_type(
        ...
        return HybridShapeReflectLine(
            self.hybrid_shape_factory.AddNewReflectLineWithType(
                i_support.com_object,
                i_dir.com_object,
                i_angle,
                i_orientation_support,
    ...
    def add_new_revol(
        ...
        return HybridShapeRevol(
            self.hybrid_shape_factory.AddNewRevol(
                i_object_to_extrude.com_object,
                i_offset_debut,
                i_offset_fin,
                i_axis.com_object,
    ...
    def add_new_spiral(
        ...
        return HybridShapeSpiral(
            self.hybrid_shape_factory.AddNewSpiral(
                i_type,
                i_support.com_object,
